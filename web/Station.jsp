<%-- 
    Document   : Station
    Created on : 24-Sept-2024, 10:30:56 pm
...
<html>
    ...
    <body>
        ...
        <div class="head">
           ...
           <form action="viewstcases" method="GET" onsubmit="setNull()" target="myframe">
        ...
        <div class="sidebar">  
            <h2>Tools</h2>
        <a href='CaseRegister.jsp' target="myframe">File Case</a>
        <a href="showaknowledgments"  id="firstlink" target="myframe">Acknowledgments</a>
