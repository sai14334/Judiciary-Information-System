...
public class AddUserDao {
    ...
    public boolean addLawyer(String username, String password, String name, String phone, String email) {
    ...
    public boolean addJudge(String username, String password, String name, String phone, String email) {
        String pass =  encryptPassword(password);
       try {
    ...
    public boolean addRegistrar(String username, String password, String name, String phone, String email) {
        String pass =  encryptPassword(password);
         try {
    ...
    public boolean addStation(String username, String password, String name, String phone, String email) {
        String pass =  encryptPassword(password);
        try{
